...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleMobileAds",
      url:
        "https://dl.google.com/googleadmobadssdk/578b6a175490a5a7/googlemobileadsios-spm-9.10.0.zip",
      checksum: "578b6a175490a5a7eee2acc818d6f0861e8323d99748ce09c4ccb7096b7aa918"
    ),
  ]
)
