...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleMobileAds",
      url:
        "https://dl.google.com/googleadmobadssdk/a5961fe42094cddf/googlemobileadsios-spm-10.5.0.zip",
      checksum: "a5961fe42094cddfb508a1ad9dfcdf291feff391b41700135333fc5ceecfa0f2"
    ),
  ]
)
