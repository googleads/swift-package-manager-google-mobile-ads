...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleMobileAds",
      url:
        "https://dl.google.com/googleadmobadssdk/fb039ccb35367dd2/googlemobileadsios-spm-11.0.1.zip",
      checksum: "fb039ccb35367dd2e925a0afc553a657b16ce0bc12268a69b8110891722d1130"
    ),
  ]
)
