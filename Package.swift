...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleMobileAds",
      url:
        "https://dl.google.com/googleadmobadssdk/bfae4c5ada9a9d1f/googlemobileadsios-spm-12.4.0.zip",
      checksum: "bfae4c5ada9a9d1ffff264dcc6f9886fb1dc4a8195c14259fe1bf487c8a860b9"
    ),
  ]
)
