...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleMobileAds",
      url:
        "https://dl.google.com/googleadmobadssdk/eeabce4666732570/googlemobileadsios-spm-13.1.0.zip",
      checksum: "eeabce466673257052bfad5c450b4fefee2e34b4ac479bede7ea50ca74085fc1"
    ),
  ]
)
