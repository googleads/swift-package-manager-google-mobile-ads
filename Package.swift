...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleMobileAds",
      url:
        "https://dl.google.com/googleadmobadssdk/f37750db872f507a/googlemobileadsios-spm-9.7.0.zip",
      checksum: "f37750db872f507ac47d25a80bf8218fb23596689b2d607dc291c326477586ae"
    ),
  ]
)
