...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleMobileAds",
      url:
        "https://dl.google.com/googleadmobadssdk/05b51e7fcbcded3c/googlemobileadsios-spm-10.0.0.zip",
      checksum: "05b51e7fcbcded3cab421158fde68c7f4e06df2aab51ccc0c0fe3e7e670889dd"
    ),
  ]
)
