...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleMobileAds",
      url:
        "https://dl.google.com/googleadmobadssdk/363b6fe04dd55d7f/googlemobileadsios-spm-13.4.0.zip",
      checksum: "363b6fe04dd55d7fd7fc854c180798e4550d3a962a29efc76938bcbb9c1ca067"
    ),
  ]
)
