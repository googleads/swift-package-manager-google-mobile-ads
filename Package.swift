...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleMobileAds",
      url:
        "https://dl.google.com/googleadmobadssdk/61fbb1ed4b596f72/googlemobileadsios-spm-12.12.0.zip",
      checksum: "61fbb1ed4b596f7260fc367525484b249d9c678fda2e1e92fd6dd74eee278b64"
    ),
  ]
)
