...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleMobileAds",
      url:
        "https://dl.google.com/googleadmobadssdk/fc88eeb0fca23ae3/googlemobileadsios-spm-13.0.0.zip",
      checksum: "fc88eeb0fca23ae31df34d92a4db1fcb4b497eb739f39378cb114ff512ce1080"
    ),
  ]
)
