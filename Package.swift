...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleMobileAds",
      url:
        "https://dl.google.com/googleadmobadssdk/12b0ae0479234ec6/googlemobileadsios-spm-10.13.0.zip",
      checksum: "12b0ae0479234ec675febc312918b9bb123a3499d643ecd25810578f9d9cd5af"
    ),
  ]
)
