...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleMobileAds",
      url:
        "https://dl.google.com/googleadmobadssdk/d557d8c71090ba98/googlemobileadsios-spm-12.3.0.zip",
      checksum: "d557d8c71090ba9811ebb34f2219978cf51f92ac75e819baa5612c6f148348db"
    ),
  ]
)
