...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleMobileAds",
      url:
        "https://dl.google.com/googleadmobadssdk/de40eb4140a3dba7/googlemobileadsios-spm-10.11.0.zip",
      checksum: "de40eb4140a3dba7976eea87517fc0128b67e22ec77fd8db2f5337e1d1311fa1"
    ),
  ]
)
