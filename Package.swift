...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleMobileAds",
      url:
        "https://dl.google.com/googleadmobadssdk/95e122edb429020f/googlemobileadsios-spm-9.13.0.zip",
      checksum: "95e122edb429020f4b92cf25065151f7322a70e6f2f8304ec7fcdd0eafb2faf2"
    ),
  ]
)
