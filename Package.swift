...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleMobileAds",
      url:
        "https://dl.google.com/googleadmobadssdk/4e2e31c9570fcd5a/googlemobileadsios-spm-11.2.0.zip",
      checksum: "4e2e31c9570fcd5a85992b82dcca080c00df38db582ec2c5c0803adb8efd0a7c"
    ),
  ]
)
