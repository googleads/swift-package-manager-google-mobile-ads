...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleMobileAds",
      url:
        "https://dl.google.com/googleadmobadssdk/fa7bd66d7b804e67/googlemobileadsios-spm-12.5.0.zip",
      checksum: "fa7bd66d7b804e67d39ea6b663525a6360fbbec13186829324ceba9d12334143"
    ),
  ]
)
