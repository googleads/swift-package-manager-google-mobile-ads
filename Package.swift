...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleMobileAds",
      url:
        "https://dl.google.com/googleadmobadssdk/115ed428d214a356/googlemobileadsios-spm-12.13.0.zip",
      checksum: "115ed428d214a356d51bf3af9582e1c1efff8564b285ac6e328114bf27f5d344"
    ),
  ]
)
