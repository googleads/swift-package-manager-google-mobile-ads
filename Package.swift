...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleMobileAds",
      url:
        "https://dl.google.com/googleadmobadssdk/d4be70557405c8fd/googlemobileadsios-spm-12.4.0.zip",
      checksum: "d4be70557405c8fd7ea44375f5c215ec7c90132b61cf10cdaad7f90a5a922b5d"
    ),
  ]
)
