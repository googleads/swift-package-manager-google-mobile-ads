...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleMobileAds",
      url:
        "https://dl.google.com/googleadmobadssdk/b3ff2bc91b9393d8/googlemobileadsios-spm-9.1.0.zip",
      checksum: "b3ff2bc91b9393d860499a114b01d492b6698a065d2da5269bf244a6bc160877"
    ),
  ]
)
