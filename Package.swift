...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleMobileAds",
      url:
        "https://dl.google.com/googleadmobadssdk/4de8f064ba64ff01/googlemobileadsios-spm-10.12.0.zip",
      checksum: "4de8f064ba64ff01cc6f97c657817acb637d6e0884a441d4ab132e77df26c820"
    ),
  ]
)
