...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleMobileAds",
      url:
        "https://dl.google.com/googleadmobadssdk/94f8c64ee70b51a1/googlemobileadsios-spm-11.10.0.zip",
      checksum: "94f8c64ee70b51a18d7fe130d6a145b47ee8c30babe63a68782a0d2e883386ed"
    ),
  ]
)
