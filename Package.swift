...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleMobileAds",
      url:
        "https://dl.google.com/googleadmobadssdk/4046677796b91631/googlemobileadsios-spm-10.9.0.zip",
      checksum: "4046677796b91631d33faad37f6a3818076a540876aeb5c871ea72533aa3fcee"
    ),
  ]
)
