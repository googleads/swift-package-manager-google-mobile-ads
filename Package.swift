...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleMobileAds",
      url:
        "https://dl.google.com/googleadmobadssdk/894a5ab608e033a9/googlemobileadsios-spm-9.9.0.zip",
      checksum: "894a5ab608e033a93a5ad3be1884f62e80aeb6c8faa7826580b3581c8e9f2bf0"
    ),
  ]
)
