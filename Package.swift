...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleMobileAds",
      url:
        "https://dl.google.com/googleadmobadssdk/08eb21393f213b1d/googlemobileadsios-spm-9.2.0.zip",
      checksum: "08eb21393f213b1d76bbdb843a7a1d0a6b2d31d0f8c126fe1ce002f17414e82c"
    ),
  ]
)
