...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleMobileAds",
      url:
        "https://dl.google.com/googleadmobadssdk/f33c46e5c7a66fc1/googlemobileadsios-spm-9.4.0.zip",
      checksum: "f33c46e5c7a66fc1ab29eabb391b01ded99cefd2080bd6f9209ad5a860467602"
    ),
  ]
)
