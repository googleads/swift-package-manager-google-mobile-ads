...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleMobileAds",
      url:
        "https://dl.google.com/googleadmobadssdk/4ecacbf5a324d85d/googlemobileadsios-spm-11.8.0.zip",
      checksum: "4ecacbf5a324d85d3ed222855343fb4f90b11f62617a15692100c47dd7668595"
    ),
  ]
)
