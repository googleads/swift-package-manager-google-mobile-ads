...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleMobileAds",
      url:
        "https://dl.google.com/googleadmobadssdk/ad9f0c178c17dff8/googlemobileadsios-spm-13.8.0.zip",
      checksum: "ad9f0c178c17dff82da68b99d3a912ad19e2f8f8b66f5bc22ddbc6aabf9bf457"
    ),
  ]
)
