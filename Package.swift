...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "GoogleMobileAds",
      url:
        "https://dl.google.com/googleadmobadssdk/7c782d87599c81a3/googlemobileadsios-spm-12.10.0.zip",
      checksum: "7c782d87599c81a32b02a92144913c8dbd2246f046e988b6d8160ac2bd4d3da4"
    ),
  ]
)
